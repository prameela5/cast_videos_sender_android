 ...
 */
public abstract class BaseCastManager implements DeviceSelectionListener, FireflyApiClient.ConnectionCallbacks,
FireflyApiClient.OnConnectionFailedListener, OnFailedListener {
    ...
    protected FireflyApiClient mApiClient;
    ...
    public void setDevice(CastDevice device, boolean stopAppOnExit) {
        ...
        if (mSelectedCastDevice == null) {
            ...
            mApiClient = new FireflyApiClient.Builder(mContext)
